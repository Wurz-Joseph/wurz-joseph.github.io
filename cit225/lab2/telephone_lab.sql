...
, creation_date               DATE         CONSTRAINT nn_telephone__7 NOT NULL
...
, CONSTRAINT fk_telephone_2   FOREIGN KEY(telephone_type) REFERENCES common_lookup_lab(common_lookup_lab_id)
