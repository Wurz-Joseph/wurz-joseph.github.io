...
, last_updated_date     DATE            constraint nn_airport_8    NOT NULL
...
(common_lookup_s1.nextval, 'LAX', 'Los Angeles', 'Los Angeles', 'California', 1, SYSDATE, 1, SYSDATE);

INSERT INTO airport VALUES
(common_lookup_s1.nextval, 'SLC', 'Salt Lake City', 'Provo', 'Utah', 1, SYSDATE, 1, SYSDATE);

INSERT INTO airport VALUES
(common_lookup_s1.nextval, 'SLC', 'Salt Lake City', 'Spanish Fork', 'Utah', 1, SYSDATE, 1, SYSDATE);

INSERT INTO airport VALUES
(common_lookup_s1.nextval, 'SFO', 'San Francisco', 'San Francisco', 'California', 1, SYSDATE, 1, SYSDATE);

INSERT INTO airport VALUES
(common_lookup_s1.nextval, 'SJC', 'San Jose', 'San Jose', 'California', 1, SYSDATE, 1, SYSDATE);

INSERT INTO airport VALUES
(common_lookup_s1.nextval, 'SJC', 'San Jose', 'San Carlos', 'California', 1, SYSDATE, 1, SYSDATE);
