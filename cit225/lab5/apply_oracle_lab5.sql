...
SELECT 
    ...
    su2.system_user_name AS "Created By User Name",
    su3.system_user_id AS "Last Updated By",
    su3.system_user_name AS "Last Updated User Name"
FROM system_user su1 INNER JOIN system_user su2
ON su1.created_by = su2.system_user_id
...
alter table "STUDENT"."RENTAL" drop constraint "NN_RENTAL_3";
